...
/// A parser that consumes a sequence of 9 typed parsers and combines
/// the successful parse with a [callback] to a result of type [R].
class SequenceMapParser9<R1, R2, R3, R4, R5, R6, R7, R8, R9, R>
    extends Parser<R> implements SequentialParser {
  SequenceMapParser9(
      this.parser1,
      this.parser2,
      this.parser3,
  ...
  Parser<R8> parser8;
  Parser<R9> parser9;
  final R Function(R1, R2, R3, R4, R5, R6, R7, R8, R9) callback;
  ...
  Result<R> parseOn(Context context) {
    ...
    return result9.success(callback(
        result1.value,
        result2.value,
        result3.value,
        result4.value,
  ...
  @override
  SequenceMapParser9<R1, R2, R3, R4, R5, R6, R7, R8, R9, R> copy() =>
