...
/// A parser that consumes a sequence of 6 typed parsers and combines
/// the successful parse with a [callback] to a result of type [R].
class SequenceMapParser6<R1, R2, R3, R4, R5, R6, R> extends Parser<R>
    implements SequentialParser {
  SequenceMapParser6(this.parser1, this.parser2, this.parser3, this.parser4,
      this.parser5, this.parser6, this.callback);
  ...
  Parser<R5> parser5;
  Parser<R6> parser6;
  final R Function(R1, R2, R3, R4, R5, R6) callback;
  ...
  Result<R> parseOn(Context context) {
    ...
    return result6.success(callback(result1.value, result2.value, result3.value,
  ...
  @override
  SequenceMapParser6<R1, R2, R3, R4, R5, R6, R> copy() =>
