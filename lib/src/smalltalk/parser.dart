...
//            .optional());
    ...
    // literals
    action('trueLiteral', (value) => new LiteralValueNode(value, true));
    action('falseLiteral', (value) => new LiteralValueNode(value, false));
    action('nilLiteral', (value) => new LiteralValueNode(value, null));
    action('charLiteral', (value) => new LiteralValueNode(value, value.inputValue[1]));
    action('stringLiteral', (Token value) => new LiteralValueNode(value,
        value.inputValue.subString(1, value.inputValue.size - 1).replace('\'\'', '\'')));
...
//    def('unaryToken', _token(ref('unary')));
    action('variable', (token) => new VariableNode(token));
  }
