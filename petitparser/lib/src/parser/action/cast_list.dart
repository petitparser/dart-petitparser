...
extension CastListParserExtension<T> on Parser<List<T>> {
...
class CastListParser<T, R> extends DelegateParser<List<T>, List<R>> {
  CastListParser(Parser<List<T>> delegate) : super(delegate);
